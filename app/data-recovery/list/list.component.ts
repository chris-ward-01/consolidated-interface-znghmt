...
@Component({
  selector: "app-data-recovery-list",
...
export class DataRecoveryListComponent implements OnInit {
  ...
  displayedColumns: string[] = ["select", "name", "engine", "last", "status", "next"];
  columnToggles: string[] = ["select", "name", "engine", "last", "status", "next"];
