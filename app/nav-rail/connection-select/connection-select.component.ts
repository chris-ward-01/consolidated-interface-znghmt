...
export class ConnectionDialogContentComponent {
  constructor(
    public dialog: MatDialogRef<ConnectionDialogContentComponent>
  ) {}
}

@Component({
  selector: "td-connection-select",
...
export class ConnectionSelectComponent implements OnInit {
  ...
  openNewConnectionDialog(): void {
    this._tdDialgoService.open(ConnectionDialogContentComponent, {
      minWidth: 400
    });
  }
}
